...
// const users: ({ password: string; role: string; fullName: string; id: number; email: string; username: string } | { password: string; role: string; fullName: string; id: number; email: string; username: string })[] = [
//   {
//     id: 1,
//     role: 'admin',
//     password: 'admin',
