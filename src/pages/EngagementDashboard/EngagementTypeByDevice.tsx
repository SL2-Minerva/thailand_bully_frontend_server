...
import { GetEngagementTypeByDevice } from 'src/services/api/dashboards/engagement/EngagementApi'
...
const EngagementTypeByDevice = (props: LineProps) => {
  ...
  const getKeywordId = (dataset: InteractionItem[]) => {
    ...
    const dailyMessageData = resultEngagementTypeByDevice?.daily_message;
  ...
  const chartDatasets = (data:any) => {
    ...
    useEffect(() => {
        if(resultEngagementTypeByDevice) {
        const dailyMessageData = resultEngagementTypeByDevice;
        if(dailyMessageData) {
    ...
    return (
      <Card>
        <span style={{ display: 'flex', justifyContent: 'flex-start' }}>
          <CardHeader
            title="Engangement Type By Device"
...
export default EngagementTypeByDevice