...
const EngagementTypeByChannel = (props: LineProps) => {
  ...
  const { resultEngagementTypeByChannel, loadingEngagementTypeByChannel } =  GetEngagementTypeByChannel(params?.campaign, params?.date, params?.endDate, params?.period);
    ...
    return (
      <Card>
        ...
        <span style={{ display: 'flex', justifyContent: 'flex-start' }}>
          <CardHeader
            title="Daily Engagement Type By Channel"
