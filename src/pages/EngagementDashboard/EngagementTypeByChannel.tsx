...
const EngagementTypeByChannel = (props: LineProps) => {
  ...
  const { resultEngagementTypeByChannel } =  GetEngagementTypeByChannel(params?.campaign, params?.date, params?.endDate, params?.period);
  ...
  const getKeywordId = (dataset: InteractionItem[]) => {
    ...
    const dailyMessageData = resultEngagementTypeByChannel?.daily_message;
    ...
    return (
      <Card>
        <span style={{ display: 'flex', justifyContent: 'flex-start' }}>
          <CardHeader
            title="Engangement Type By Channel"
