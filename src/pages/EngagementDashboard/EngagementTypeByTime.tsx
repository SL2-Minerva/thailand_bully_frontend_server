...
const EngagementTypeByTime = (props: LineProps) => {
  ...
  const { resultEngagementTypeByDay } = GetEngagementTypeByDay(params?.campaign, params?.date, params?.endDate, params?.period);
  ...
  const getKeywordId = (dataset: InteractionItem[]) => {
    ...
    const dailyMessageData = resultEngagementTypeByDay?.daily_message;
...
export default EngagementTypeByTime