...
const EngagementTypeByAccount = (props: LineProps) => {
  ...
  const { resultEngagementTypeByAccount } = GetEngagementTypeByAccount(params?.campaign, params?.date, params?.endDate, params?.period);
  ...
  const getKeywordId = (dataset: InteractionItem[]) => {
    ...
    const dailyMessageData = resultEngagementTypeByAccount?.daily_message;
    ...
    return (
      <Card>
        <span style={{ display: 'flex', justifyContent: 'flex-start' }}>
          <CardHeader
            title="Engangement Type By Account"
