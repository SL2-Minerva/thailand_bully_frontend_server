...
const onCapture = () => {
  ...
  if (pictureId) {
    htmlToImage.toPng(pictureId, { backgroundColor: '#fff' }).then(function (dataUrl) {
      saveAs(dataUrl, 'Daily Engagement Type By Account.png')
    })
  }
}
    ...
    <Paper sx={{ border: `3px solid #fff`, borderRadius: 1 }}>
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between' }}>
        <span style={{ display: 'flex', justifyContent: 'flex-start' }}>
          <CardHeader
            title={<Translations text='Daily Engagement Type By Account' />}
            ...
            title={
              <span>
                <Typography variant='h6' sx={{ color: 'white' }}>
                  <Translations text='engagementChart14Title' />
                </Typography>
                <Typography variant='body2' sx={{ color: 'white' }}>
                  <Translations text='engagementChart14Description' />
                </Typography>
              </span>
            }
          >
        ...
        <span style={{ display: 'flex', justifyContent: 'flex-end' }}>
          ...
          >
            ...
            <ExportExcel
              ...
              fileName='Daily Engagement Type by Account.xlsx'
