...
const EngagementTypeByAccount = (props: LineProps) => {
  ...
  const { resultEngagementTypeByAccount, loadingEngagementTypeByAccount } = GetEngagementTypeByAccount(params?.campaign, params?.date, params?.endDate, params?.period);
