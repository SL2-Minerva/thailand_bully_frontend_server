...
const EngagementByDay = (props: LineProps) => {
  ...
  return (
    <Paper sx={{ border: `3px solid #fff`, borderRadius: 1, minHeight: '300px' }}>
            ...
            title={
              <span>
                <Typography variant='h6' sx={{ color: 'white' }}>
                  <Translations text='engagementChart3Title' />
                </Typography>
                <Typography variant='body2' sx={{ color: 'white' }}>
                  <Translations text='engagementChart3Description' />
                </Typography>
              </span>
            }
          >
        ...
        <span style={{ display: 'flex', justifyContent: 'flex-end' }}>
          ...
          >
            ...
            <ExportExcel
              ...
              fileName='Daily Engagement Trans by Day.xlsx'
