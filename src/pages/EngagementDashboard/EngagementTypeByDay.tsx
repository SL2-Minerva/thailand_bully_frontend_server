...
const onCapture = () => {
  ...
  if (pictureId) {
    htmlToImage.toPng(pictureId, { backgroundColor: '#fff' }).then(function (dataUrl) {
      saveAs(dataUrl, 'Daily Engagement Type By Day.png')
    })
  }
}
            ...
            title={
              <span>
                <Typography variant='h6' sx={{ color: 'white' }}>
                  <Translations text='engagementChart11Title' />
                </Typography>
                <Typography variant='body2' sx={{ color: 'white' }}>
                  <Translations text='engagementChart11Description' />
                </Typography>
              </span>
            }
          >
        ...
        <span style={{ display: 'flex', justifyContent: 'flex-end' }}>
          ...
          >
            ...
            <ExportExcel
              ...
              fileName='Daily Engagement Type by Day.xlsx'
