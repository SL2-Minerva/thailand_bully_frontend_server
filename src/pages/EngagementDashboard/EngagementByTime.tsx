...
import { GetMessagesByTime } from 'src/services/api/dashboards/engagement/EngagementApi'
...
const EngagementByTime = (props: LineProps) => {
  ...
  const { resultMessagesByTime } = GetMessagesByTime(params?.campaign, params?.date, params?.endDate, params?.period);
  ...
  const getKeywordId = (dataset: InteractionItem[]) => {
    ...
    const dailyMessageData = resultMessagesByTime?.daily_message;
  ...
  const chartDatasets = (data:any) => {
    ...
    useEffect(() => {
        ...
        const dailyMessageData = resultMessagesByTime;
        if(dailyMessageData) {
