...
const SentimentByDay = (props: LineProps) => {
  ...
  const { resultSentimentByDay } = GetSenitmemntByDay(params?.campaign, params?.date, params?.endDate, params?.period);
  ...
  const getKeywordId = (dataset: InteractionItem[]) => {
    ...
    const dailyMessageData = resultSentimentByDay?.daily_message;
