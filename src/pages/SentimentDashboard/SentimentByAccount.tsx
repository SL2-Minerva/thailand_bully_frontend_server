...
const SentimentByAccount = (props: LineProps) => {
  ...
  const { resultSentimentByAccount } = GetSentimentByAccount(params?.campaign, params?.date, params?.endDate, params?.period);
  ...
  const getKeywordId = (dataset: InteractionItem[]) => {
    ...
    const dailyMessageData = resultSentimentByAccount?.daily_message;
