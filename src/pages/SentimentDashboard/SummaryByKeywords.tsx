...
const SummaryByKeywords = ({params, chartId, highlight} :
    ...
    const { resultSummaryByKeywords, total, loadingSummaryByKeywords } = GetSummaryByKeywords(topKeyword, params?.campaign, params?.date, params?.endDate, params?.period, 0, params?.keywordIds);
