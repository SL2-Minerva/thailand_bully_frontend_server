...
const SentimentByTime = (props: LineProps) => {
  ...
  const { resultSentimentByTime  } = GetSentimentByTime(params?.campaign, params?.date, params?.endDate, params?.period);
  ...
  const getKeywordId = (dataset: InteractionItem[]) => {
    ...
    const dailyMessageData = resultSentimentByTime?.daily_message;
