...
import {  GetSentimentByTime } from 'src/services/api/dashboards/sentiment/sentimentDashboard'
...
const SentimentByTime = (props: LineProps) => {
  ...
  const { resultSentimentByTime, loadingSentimentByTime  } = GetSentimentByTime(params?.campaign, params?.date, params?.endDate, params?.period, params?.keywordIds);
  ...
  const getKeywordId = (dataset: InteractionItem[]) => {
    ...
    const dailyMessageData = resultSentimentByTime?.value;
  ...
  const chartDatasets = (data:any) => {
    ...
    useEffect(() => {
        if(resultSentimentByTime) {
        const dailyMessageData = resultSentimentByTime;
        if(dailyMessageData) {
