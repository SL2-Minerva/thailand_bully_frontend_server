...
import {  GetSentimentByBullyLevel } from 'src/services/api/dashboards/sentiment/sentimentDashboard'
...
const SentimentByBullyLevel = (props: LineProps) => {
  ...
  const { resultSentimentByBullyLevel, loadingSentimentByBullyLevel } = GetSentimentByBullyLevel(params?.campaign, params?.date, params?.endDate, params?.period, params?.keywordIds);
  ...
  const getKeywordId = (dataset: InteractionItem[]) => {
    ...
    const dailyMessageData = resultSentimentByBullyLevel?.value;
  ...
  const chartDatasets = (data:any) => {
    ...
    useEffect(() => {
        if(resultSentimentByBullyLevel) {
        const dailyMessageData = resultSentimentByBullyLevel;
        if(dailyMessageData) {
...
export default SentimentByBullyLevel