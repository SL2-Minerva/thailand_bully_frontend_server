          ...
          <PerfectScrollbar options={{ wheelPropagation: false }}>
            <CustomizerSpacing className='customizer-body'>
              ...
              <Link to="chart14" spy={true} smooth={true}>
                <Box sx={{ mb: 4 }} onClick={() => {setOpen(false)}}>
                    <Typography>Chart 14 : Sentiment Score</Typography>
                </Box>
              </Link>
              <Divider sx={{ m: 0 }} />
              ...
              <Link to="chart15" spy={true} smooth={true}>
                <Box sx={{ mb: 4 }} onClick={() => {setOpen(false)}}>
                    <Typography>Chart 15 : Engagement Type Comparison</Typography>
                </Box>
              </Link>
              <Divider sx={{ m: 0 }} />
              ...
              <Link to="chart16" spy={true} smooth={true}>
                <Box sx={{ mb: 4 }} onClick={() => {setOpen(false)}}>
                    <Typography>Chart 16 : Summary Sentiment Score by Account</Typography>
                </Box>
              </Link>
              <Divider sx={{ m: 0 }} />
              ...
              <Link to="chart17" spy={true} smooth={true}>
                <Box sx={{ mb: 4 }} onClick={() => {setOpen(false)}}>
                    <Typography>Chart 17 : Summary Sentiment Score by Channel</Typography>
                </Box>
              </Link>
              <Divider sx={{ m: 0 }} />
              ...
              <Link to="chart18" spy={true} smooth={true}>
                <Box sx={{ mb: 4 }} onClick={() => {setOpen(false)}}>
                    <Typography>Chart 18 : Keywords</Typography>
                </Box>
              </Link>
              <Divider sx={{ m: 0 }} />
