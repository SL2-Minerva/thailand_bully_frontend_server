...
const MessagesBySentiment = (props: LineProps) => {
  ...
  const { resultMessagesBySentiment } = GetMessagesBySentiment(params?.campaign, params?.date, params?.endDate, params?.period);
  ...
  const getKeywordId = (dataset: InteractionItem[]) => {
    ...
    const dailyMessageData = resultMessagesBySentiment?.daily_message;
