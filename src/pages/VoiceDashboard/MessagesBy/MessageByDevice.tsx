...
const onCapture = () => {
  const pictureId = document.getElementById('messageByDevice')
  if (pictureId) {
    htmlToImage.toPng(pictureId, { backgroundColor: '#fff' }).then(function (dataUrl) {
      saveAs(dataUrl, 'Daily Message By Device(voice dashboard).png')
    })
  }
}
...
const MessagesByDevices = (props: LineProps) => {
  ...
  return (
    <Paper sx={{ border: `3px solid #fff`, borderRadius: 1 }}>
            ...
            title={
              <span>
                <Typography variant='h6' sx={{ color: 'white' }}>
                  <Translations text='voiceChart5Title' />
                </Typography>
                <Typography variant='body2' sx={{ color: 'white' }}>
                  <Translations text='voiceChart5Description' />
                </Typography>
              </span>
            }
          >
      ...
      <CardContent id='messageByDevice'>
        {showNoDataText ? (
          <div
            style={{
              height: 300,
...
export default MessagesByDevices
