...
const onCapture = () => {
  const pictureId = document.getElementById('messagesByBullyType')
  if (pictureId) {
    htmlToImage.toPng(pictureId, { backgroundColor: '#fff' }).then(function (dataUrl) {
      saveAs(dataUrl, 'Daily Messages by Bully Type(voice dashboard).png')
    })
  }
}
...
const MessagesByBullyType = (props: LineProps) => {
  ...
  return (
    <Paper sx={{ border: `3px solid #fff`, borderRadius: 1 }} >
            ...
            title={
              <span>
                <Typography variant='h6' sx={{ color: 'white' }}>
                  <Translations text='voiceChart10Title' />
                </Typography>
                <Typography variant='body2' sx={{ color: 'white' }}>
                  <Translations text='voiceChart10Description' />
                </Typography>
              </span>
            }
          >
      ...
      <CardContent id='messagesByBullyType'>
        {showNoDataText ? (
          <div
            style={{
              height: 300,
