...
const MessagesByDevices = (props: LineProps) => {
  ...
  const { resultMessagesByDevice, loadingMessagesByDevice } = GetMessagesByDevice(
    params?.campaign,
    params?.date,
    params?.endDate,
    params?.period,
  ...
  const chartDatasets = (data: any) => {
    ...
    const color = loadingMessagesByDevice && keywordsColor ? keywordsColor  : GraphicColors
  ...
  return (
    <Paper sx={{ border: `3px solid #fff`, borderRadius: 1 }} square variant='outlined'>
      {loadingMessagesByDevice && <LinearProgress style={{ width: '100%' }} />}
