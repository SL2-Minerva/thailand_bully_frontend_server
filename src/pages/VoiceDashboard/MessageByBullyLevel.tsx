...
const MessagesByBullyLevel = (props: LineProps) => {
  ...
  const { resultMessagesByBullyLevel } = GetMessagesByBullyLevel(params?.campaign, params?.date, params?.endDate, params?.period);
  ...
  const getKeywordId = (dataset: InteractionItem[]) => {
    ...
    const dailyMessageData = resultMessagesByBullyLevel?.daily_message;
