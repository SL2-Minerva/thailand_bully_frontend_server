            ...
            <CustomizerSpacing className='customizer-body'>
              ...
              <Divider sx={{ m: 0 }} />
                <Box sx={{ mb: 6, mt: 6 }} onClick={() => {onClose("chart5")}}>
                    <Typography sx={{ color : highlightText === 'chart5' ? 'green' : '#4c4e64de'  }}>By Devices</Typography>
                </Box>
              <Divider sx={{ m: 0 }} />
              ...
              <Divider sx={{ m: 0 }} />
                <Box sx={{ mb: 6, mt: 6 }} onClick={() => {onClose("chart8")}}>
                    <Typography sx={{ color : highlightText === 'chart8' ? 'green' : '#4c4e64de'  }}>By Sentiment</Typography>
                </Box>
              <Divider sx={{ m: 0 }} />
                <Box sx={{ mb: 6, mt: 6 }} onClick={() => {onClose("chart9")}}>
                    <Typography sx={{ color : highlightText === 'chart9' ? 'green' : '#4c4e64de'  }}>By Bully Level </Typography>
                </Box>
              <Divider sx={{ m: 0 }} />
                <Box sx={{ mb: 6, mt: 6 }} onClick={() => {onClose("chart10")}}>
                    <Typography sx={{ color : highlightText === 'chart10' ? 'green' : '#4c4e64de'  }}>By Bully Type</Typography>
                </Box>
              <Divider sx={{ m: 0 }} />
