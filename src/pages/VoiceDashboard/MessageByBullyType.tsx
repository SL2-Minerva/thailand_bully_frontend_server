...
const MessagesByBullyType = (props: LineProps) => {
  ...
  const { resultMessagesByBullyType, loadingMessagesByBullyType } = GetMessagesByBullyType(params?.campaign, params?.date, params?.endDate, params?.period, params?.keywordIds);
  ...
  const getKeywordId = (dataset: InteractionItem[]) => {
    ...
    const dailyMessageData = resultMessagesByBullyType?.value;
  ...
  useEffect(() =>{
    ...
    useEffect(() => {
        if(resultMessagesByBullyType) {
        const dailyMessageData = resultMessagesByBullyType;
        if(dailyMessageData) {
...
export default MessagesByBullyType