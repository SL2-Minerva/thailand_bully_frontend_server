...
const DayTimeBullyLevel = (props : Props) => {
    ...
    const { resultTimeByBullyLevel, resultDayByBullyLevel, loadingByBullyLevel } = GetDayTimeByBullyLevel(params?.campaign, params?.date, params?.endDate, params?.period);
