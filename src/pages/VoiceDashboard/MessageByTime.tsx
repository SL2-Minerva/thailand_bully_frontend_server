...
const MessagesByTime = (props: LineProps) => {
  ...
  const { resultMessagesByTime, loadingMessagesByTime } = GetMessagesByTime(
    params?.campaign,
    params?.date,
    params?.endDate,
    params?.period,
  ...
  const chartDatasets = (data: any) => {
    ...
    const color = loadingMessagesByTime && keywordsColor ? keywordsColor : GraphicColors
  ...
  return (
    <Paper sx={{ border: `3px solid #fff`, borderRadius: 1 }} square variant='outlined'>
      {loadingMessagesByTime && <LinearProgress style={{ width: '100%' }} />}
