...
const ChannelByAccount = (props: LineProps) => {
  ...
  const { resultChannelByAccount, loadingChannelByAccount } = GetChannelByAccount(params?.campaign, params?.date, params?.endDate, params?.period, params?.keywordIds);
    ...
    return (
      <Paper sx={{ border: `3px solid #fff`, borderRadius: 1 }} square variant='outlined'>
        ...
        <span style={{ display: 'flex', justifyContent: 'flex-start' }}>
          <CardHeader
            title="Daily Messages By Account"
