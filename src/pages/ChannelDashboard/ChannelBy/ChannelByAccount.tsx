...
const onCapture = () => {
  const pictureId = document.getElementById('channelbyAccount')
  if (pictureId) {
    htmlToImage.toPng(pictureId, { backgroundColor: '#fff' }).then(function (dataUrl) {
      saveAs(dataUrl, 'Daily Messages By Accounts.png')
    })
  }
}
...
const ChannelByAccount = (props: LineProps) => {
  ...
  return (
    <Paper sx={{ border: `3px solid #fff`, borderRadius: 1 }} >
            ...
            title={
              <span>
                <Typography variant='h6' sx={{ color: 'white' }}>
                  <Translations text='channelChart6Title' />
                </Typography>
                <Typography variant='body2' sx={{ color: 'white' }}>
                  <Translations text='channelChart6Description' />
                </Typography>
              </span>
            }
          >
        ...
        <span style={{ display: 'flex', justifyContent: 'flex-end' }}>
          ...
          >
            ...
            <ExportExcel
              ...
              fileName='Daily Messages by Account(channel).xlsx'
      ...
      <CardContent id='channelbyAccount'>
        {showNoDataText ? (
          <div
            style={{
              height: 300,
