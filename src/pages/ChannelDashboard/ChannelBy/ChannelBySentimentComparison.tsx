...
const onCapture = () => {
  const pictureId = document.getElementById('channelBySentiments')
  if (pictureId) {
    htmlToImage.toPng(pictureId, { backgroundColor: '#fff' }).then(function (dataUrl) {
      saveAs(dataUrl, 'Daily Messages By Sentiment.png')
    })
  }
}
...
const ChannelBySentimentComparison = (props: LineProps) => {
  ...
  return (
    <Paper sx={{ border: `3px solid #fff`, borderRadius: 1 }}>
            ...
            title={
              <span>
                <Typography variant='h6' sx={{ color: 'white' }}>
                  <Translations text='channelChart7Title' />
                </Typography>
                <Typography variant='body2' sx={{ color: 'white' }}>
                  <Translations text='channelChart7Description' />
                </Typography>
              </span>
            }
          >
      ...
      <CardContent id='channelBySentiments'>
        {showNoDataText ? (
          <div
            style={{
              height: 300,
