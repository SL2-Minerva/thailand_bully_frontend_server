...
const ChannelByDay = (props: LineProps) => {
  ...
  const { resultChannelByDay, loadingChannelByDay } = GetChannelByDay(params?.campaign, params?.date, params?.endDate, params?.period, params?.keywordIds);
  ...
  const chartDatasets = (data:any) => {
    ...
    useEffect(() => {
        ...
        const dailyMessageData = resultChannelByDay;
        if(dailyMessageData) {
