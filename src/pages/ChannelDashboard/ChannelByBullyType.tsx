...
const ChannelByBullyType = (props: LineProps) => {
  ...
  const { resultChannelByBullyType, loadingChannelByBullyType } = GetChannelByBullyType(params?.campaign, params?.date, params?.endDate, params?.period, params?.keywordIds);
