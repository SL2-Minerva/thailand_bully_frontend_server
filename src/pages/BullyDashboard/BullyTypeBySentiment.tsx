...
const onCapture = () => {
  const pictureId = document.getElementById('typeBySentiment')
  if (pictureId) {
    htmlToImage.toPng(pictureId, { backgroundColor: '#fff' }).then(function (dataUrl) {
      saveAs(dataUrl, 'Bully Type: Daily Message by Sentiment.png')
    })
  }
}
    ...
    <Paper sx={{ border: `3px solid #fff`, borderRadius: 1 }} >
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between' }}>
        <span style={{ display: 'flex', justifyContent: 'flex-start' }}>
          <CardHeader
            title={<Translations text='Bully Type: Daily Message by Sentiment' />}
            ...
            title={
              <span>
                <Typography variant='h6' sx={{ color: 'white' }}>
                  <Translations text='bullyChart16Title' />
                </Typography>
                <Typography variant='body2' sx={{ color: 'white' }}>
                  <Translations text='bullyChart16Description' />
                </Typography>
              </span>
            }
          >
        ...
        <span style={{ display: 'flex', justifyContent: 'flex-end' }}>
          ...
          >
            ...
            <ExportExcel
              ...
              fileName='Bully Type: Daily Messages by Sentiment.xlsx'
      ...
      <CardContent id='typeBySentiment'>
        {showNoDataText ? (
          <div
            style={{
              height: 300,
