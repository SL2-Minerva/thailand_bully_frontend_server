...
const BullyTypeByChannel = (props: LineProps) => {
  ...
  const {resultBullyTypeByChannel} = GetBullyTypeByChannel(params?.campaign, params?.date, params?.endDate, params?.period);
  ...
  const getKeywordId = (dataset: InteractionItem[]) => {
    ...
    const dailyMessageData = resultBullyTypeByChannel?.daily_message;
