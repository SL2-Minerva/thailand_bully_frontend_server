...
const BullyTypeByDevice = (props: LineProps) => {
  ...
  const {resultBullyTypeByDevice, loadingBullyTypeByDevice} = GetBullyTypeByDevice(params?.campaign, params?.date, params?.endDate, params?.period);
    ...
    return (
      <Card>
        ...
        <span style={{ display: 'flex', justifyContent: 'flex-start' }}>
          <CardHeader
            title="Bully Type: Daily Message by Device"
...
export default BullyTypeByDevice